<template>
	<q-page class="row justify-evenly q-pt-lg items-start reverse">
		...
		<q-banner v-else-if="character == null" class="bg-negative">Character not found</q-banner>
		<template v-else>
				...
				<q-card-section>
					<q-list>
						...
						<q-item>
							...
							<q-item-section v-if="character.character_sheet"><a :href="character.character_sheet" class="text-white">{{character.character_sheet}}</a></q-item-section>
						...
						<q-item v-if="character.personality_traits">
							...
							<q-item-section>{{character.personality_traits}}</q-item-section>
						</q-item>
						...
						<q-item v-if="character.personal_possessions">
							...
							<q-item-section>{{character.personal_possessions}}</q-item-section>
						</q-item>
